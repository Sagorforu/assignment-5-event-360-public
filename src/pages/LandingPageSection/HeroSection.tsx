...
const HeroSection = () => {
  return (
    <div>
      <div className="mt-32 bg-[#F5F6F7]">
        <div>
          <div className="lg:flex gap-[128px] text-[#061C3D] items-center justify-between">
            <h1 className="text-3xl lg:text-[64px] font-extrabold uppercase lg:leading-[70px]">
